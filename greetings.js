...
const morningGreetings = [
  "Доброе утречко, {name}! 😊",
  "С добрым утром, {name}! 😊",
  "С добрым утречком, {name}! 😊",
  "Привет, {name}! Хорошего тебе настроения! 😊",
  "Приветик, {name}! Пора вставать! 😊",
  "Утро доброе, {name}! 😊",
  "Доброго утра, {name}! 😊",
  "Доброе утро, {name}! 😊",
  "С новым днём, {name}! 😊",
  "Удачи во всех твоих делах, {name}! 🍀",
  "Хорошего дня, {name}! 😊",
  "Просыпайся, {name}! ☕",
  "Бодрого утра, {name}! ☕",
];
...
const eveningGreetings = [
  ...
  "Споки, {name}! 😴",
  "Спокойной ночи, {name}! 😴",
  "Отдыхай и набирайся сил, {name}! 😴",
  "Отдыхай, {name}! Всё остальное подождёт до завтра 😴",
  "Сладких сновидений, {name}! 😴",
  "Хорошего отдыха, {name}! 😴",
  "{name}, Время расслабиться 🛏️",
  "Скорее в кроватку, {name}! 🛏️",
  "Спи сладко, {name}! 😴",
  "Спи крепко, {name}! 😴",
  "Добрых снов, {name}! 😴",
  "Набирайся сил, {name}! 😴",
